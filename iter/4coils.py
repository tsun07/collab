...
#breaks = np.linspace(np.amin(current_potential_plot)-10.,np.amax(current_potential_plot)+10.,ncont)
#breaks = [-max_phi/2.,max_phi/2.]
#breaks = [-2.*max_phi/3.,-max_phi/3.,max_phi/3.,2.*max_phi/3.]
breaks = [-2.*max_phi/4.,-max_phi/4.,max_phi/4.,2.*max_phi/4.]
#breaks = [-3.*max_phi/4.,-max_phi/2.,-max_phi/4.,max_phi/4.,max_phi/2.,3.*max_phi/4.]
ncont = len(breaks)
plt.figure()
